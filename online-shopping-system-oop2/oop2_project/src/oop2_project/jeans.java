 ...
 * @author msi9
 */
public class jeans extends JFrame {
    
     String product_name[]={"product 1","product 2","product 3","product 4"};
    String images[]={"jeans1.jpg","jeans2.jpg","jeans3.jpg","jeans4.jpg"};
    ...
    JLabel text = new JLabel("JEANS PAGE",SwingConstants.CENTER);
