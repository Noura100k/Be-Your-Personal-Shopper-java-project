...
public class Accessories extends JFrame {
     ...
     String product_name[]={"product1","product2","product3","product4"};
    String images[]={"acc1.jpg","acc2.jpg","acc3.jpg","acc4.jpg"};
    ...
    JLabel text = new JLabel("ACCESSORIES PAGE",SwingConstants.CENTER);
      ...
      public class handler implements ActionListener
    {
        ...
        else
        {
           ...
           JOptionPane.showMessageDialog(Accessories.this,"done of design tool","outfit",JOptionPane.INFORMATION_MESSAGE);
